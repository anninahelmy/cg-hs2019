...
of the expected results. The reason therefor was that we had a multiplication with the materialfactor at the wrong place in the loop so we multiplied to much. That made the second light canceled out. 
So there was only one light to produce the shadow what is exactly what we have seen in the wrong picture. 


Reflections: 
We recursively calculate the additional reflection part of the actual color. 
