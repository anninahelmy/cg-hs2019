...
The image didn't look completely wrong. Something was wrong with the light.
...
Having now implemented the box intersection we could correct our mistakes in the functions for the normals and intersection. In the determinant calculation we had a copy-paste-error.
...
3. Next we did some fine tuning:
...
4. After having done this, everything looked OK except for the toon_faces. We had some weird black stripes. Debugging this was quite hard. 
